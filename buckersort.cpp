...
void solve() {
	// implementing counting sort here
	// primary condition is that it should have the value in a range of the array holding range

	// so letes imply it

	// algo is
	// 1 ) create 3 vector , a ( n , 0 ) , b ( n , 0) , c ( max_ele in a + 1 , 0 )
	// 2 ) make frquency of element present in a in c
	// 3 ) find the cummulative sum of elements in c
	// 4 ) now place the elements in array b
